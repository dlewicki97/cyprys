...
class Rental_squares extends CI_Controller {
	...
	public function menu_order() {
		if (!$this->db->field_exists('menu_order', $this->uri->segment(2))) {
			$this->base_m->create_column($this->uri->segment(2), 'menu_order');
				}
		$insert['menu_order'] = $_POST['menu_order'];
		$this->back_m->update($this->uri->segment(2), $insert, $_POST['id']);
	}
