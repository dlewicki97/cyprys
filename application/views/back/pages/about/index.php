            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle"><?= substr(strip_tags($value->description), 0, 70); if(strlen($value->description) > 70) echo '...' ?></td>
                  <td class="text-right">
                      <a href="<?php echo base_url(); ?>panel/about_icons/list/<?php echo $value->id; ?>" class="btn btn-sm btn-secondary"><i class="fas fa-list mg-r-10"></i> Ikony</a>
