...
<div class="br-sideleft overflow-y-auto">
  ...
  <div class="br-sideleft-menu">
    ...
    <?php $links = ['Slider' => 'slider', 'Alert' => 'alert']; ?>
  ...
  <?php $links = ['Witamy' => 'welcome', 'O nas' => 'about', 'Opisy' => 'about_descriptions']; ?>
    <a href="#" class="br-menu-link
    <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
    <div class="br-menu-item">
  ...
  <?php $links = ['Wypożyczalnia' => 'rental', 'Kafelki' => 'rental_squares', 'Opisy' => 'rental_descriptions']; ?>
    <a href="#" class="br-menu-link
    <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
    <div class="br-menu-item">
      <i class="menu-item-icon icon fas fa-retweet tx-20"></i>
      <span class="menu-item-label">Wypożyczalnia</span>
      <i class="menu-item-arrow fa fa-angle-down"></i>
    </div>
  </a>
  <ul class="br-menu-sub nav flex-column">
  ...
  <?php $links = ['Slajdy' => 'services']; ?>
    <a href="#" class="br-menu-link
    <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
    <div class="br-menu-item">
      <i class="menu-item-icon icon fas fa-hammer tx-20"></i>
      <span class="menu-item-label">Serwis</span>
      <i class="menu-item-arrow fa fa-angle-down"></i>
    </div>
  </a>
  <ul class="br-menu-sub nav flex-column">
  ...
  <a href="<?php echo base_url(); ?>panel/advices" class="br-menu-link
    <?php if($this->uri->segment(2) == 'advices'){echo 'active';} ?>">
    <div class="br-menu-item">
      <i class="menu-item-icon icon fas fa-book tx-20"></i>
      <span class="menu-item-label">Porady</span>
    </div>
  </a>

  <?php $links = ['Działy' => 'departments', 'Opisy' => 'contact_descriptions']; ?>
    <a href="#" class="br-menu-link
    <?php if(in_array($this->uri->segment(2), $links)){echo 'show-sub';} ?>">
    <div class="br-menu-item">
  ...
  <div class="tab-content">
    ...
    <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="contact" role="tabpanel">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="pd-y-20 pd-r-25 tx-white">
            <h6 class="tx-13 tx-normal">Fax:</h6>
            <div class="pos-relative">
              <input type="text" id="fax1" name="fax1" onchange="updateField('fax1' , 'contact_settings')" value="<?php echo @$contact->fax1; ?>" class="form-control form-control-inverse transition pd-y-10">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="pd-y-20 pd-l-25 tx-white">
            <h6 class="tx-13 tx-normal">Etykieta:</h6>
            <div class="pos-relative">
              <input type="text" id="label7" name="label7" onchange="updateField('label7' , 'contact_settings')" value="<?php echo @$contact->label7; ?>" class="form-control form-control-inverse transition pd-y-10">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-8">
          <div class="pd-y-20 pd-r-25 tx-white">
            <h6 class="tx-13 tx-normal">Fax:</h6>
            <div class="pos-relative">
              <input type="text" id="fax2" name="fax2" onchange="updateField('fax2' , 'contact_settings')" value="<?php echo @$contact->fax2; ?>" class="form-control form-control-inverse transition pd-y-10">
            </div>
          </div>
        </div>
      </div>
